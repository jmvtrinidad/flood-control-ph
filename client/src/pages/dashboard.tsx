...
export default function Dashboard() {
  ...
  const getTabFromURL = (): Tab => {
    ...
    return ['overview', 'data-table', 'map'].includes(tab) ? tab : 'overview';
  };
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'overview':
        return <OverviewTab projects={projects} isLoading={isLoading} filters={combinedFilters} onLocationClick={handleLocationClick} onRegionClick={handleRegionClick} onContractorSelect={handleContractorSelect} />;
      case 'data-table':
